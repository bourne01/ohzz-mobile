            ...
            <div class="detail-popup" >
                ...
                <div class="class-detail">
                    ...
                    <div class="current-week">
                            ...
                            <span>{{curMonth}}月&nbsp;-&nbsp;第{{currentWeek}}周</span>
                    </div>
...
<script>
import { getCurrentWeek } from '../../api/api';
export default {
    props:['row','column','my-class','class-table','teacher-name','current-week'],
    data(){
        return{
    ...
    created(){        
        ...
        for(let i=this.row;i<classTableLen;i++){
            ...
            if(_curClass.name == courseName && _curClass.classname == _className && _curClass.isShow == false){//同列中是否存在连续的同名且同教室的课程，且未被显示
                this.courseSpan++;
        ...
        if(this.column == 0){
            ...
            this.classInfo = "<span>"+this.mySubString(this.myClass.name)+"</span>"/*'<br>'+
